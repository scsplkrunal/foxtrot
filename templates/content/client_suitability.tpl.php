...
<h1>Client Suitability</h1>
    <div class="col-lg-12 well">
        ...
        <div class="tab-content col-md-10">
                <div class="tab-pane <?php if((isset($_GET['action'])&& $_GET['action']=='add_new_income') || (isset($_GET['action'])&& $_GET['action']=='view_income') ){?>active<?php }?>" id="tab_a">
                    ...
                    <?php //$_GET['action']='';
                        if($action=='add_new_income' || ($action=='edit_income' && $id>0)){
                                ...
                                <div class="panel-overlay-wrap">
                                    <div class="panel">
                    					<div class="panel-heading">
                                            ...
                                            <h3 class="panel-title"><i class="ti-pencil-alt"></i> <?php echo $action=='add_new_income'?'Add':'Edit'; ?> Client Suitability</h3>
                                            ...
                                            <div class="panel-footer">
                                                <div class="selectwrap">
                                					...
                                					<input type="submit" name="submit_income" value="Save"/>	
                           ...
                           <?php } if(isset($_GET['action'])=='' || $_GET['action']=='view_income') { ?> 
                        <div class="panel">
                            <div class="panel-heading">
                ...
                <div class="tab-pane <?php if((isset($_GET['action'])&& $_GET['action']=='add_new_horizon') || (isset($_GET['action'])&& $_GET['action']=='view') ){?>active<?php }?>"" id="tab_b">
                     <?php
                                ...
                                <div class="panel-overlay-wrap">
                                    <div class="panel">
                    					<div class="panel-heading">
                                            ...
                                            <h3 class="panel-title"><i class="ti-pencil-alt"></i> <?php echo $action=='add_new_horizon'?'Add':'Edit'; ?> Client Suitability</h3>
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                            ...
                                            <div class="panel-footer">
                                                <div class="selectwrap">
                                                    <input type="hidden" name="id" id="id" value="<?php echo $id; ?>" />
                                					<input type="submit" name="submit_horizon" value="Save"/>	
                                                    <a href="<?php echo CURRENT_PAGE;?>"><input type="button" name="cancel" value="Cancel" /></a>
                                                </div>
                                            </div>
                                        </div>
