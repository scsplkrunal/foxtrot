        ...
        <div class="tab-content col-md-10">
                ...
                <!-- Lightbox strart -->							
					...
					<div id="client_notes" class="modal fade inputpopupwrap" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
						...
						<form method="post" id="add_notes" onsubmit="return formsubmitnotes();">
						<div class="inputpopup">
							<label>Select Notebook:<span>*</span></label>
							<select name="notebook_id">
								<option selected="selected" value="0">Select Notebook</option>
								<?php foreach($notebook as $key=>$val){?>
    							 <option <?php echo isset($notebook_id)&&$notebook_id==$val['id']?'selected="selected"':''; ?> value="<?php echo $val['id'];?>"><?php echo $val['name']; ?></option>
    	                        <?php } ?>
							</select>
						</div>
						<div class="inputpopup">
							<label>Enter Note Name:<span>*</span></label>
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label></label><br />
                                                <a href="#client_notes"><input type="button" name="notes" value="Notes" /></a>
