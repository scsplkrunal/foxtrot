			...
			if($this->errors!=''){
				...
				*/
				if($this->errors!=''){
					...
					if($id==0){
						$q = "INSERT INTO `".$this->table."` SET `company_name`='".$company_name."',`address1`='".$address1."',`address2`='".$address2."',`business_city`='".$business_city."',`state_general`='".$state_general."',
                        `zip`='".$zip."',`mail_address1`='".$mail_address1."',`mail_address2`='".$mail_address2."',`m_city`='".$m_city."',`m_zip`='".$m_zip."',`telephone`='".$telephone."',`facsimile`='".$facsimile."',
                        ...
                        `p_rate`='".$p_rate."',`threshold1`='".$threshold1."',`l1_rate`='".$l1_rate."',`threshold2`='".$threshold2."',`l2_rate`='".$l2_rate."',`threshold3`='".$threshold3."',`l3_rate`='".$l3_rate."',
